...
public class Controller {
    ...
    // Добавление существ Замка (Castle)
      OffenseCreatures Pikeman = new OffenseCreatures("Pikeman",4,5,10,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures Halberdier = new OffenseCreatures("Halberdier",6,5,10,2,3,1,0,0,1,0,0,"","",1);
      ArcheryCreatures Archer = new ArcheryCreatures("Archer",6,3,10,2,3,1,0,0,2,0,0,"","",1);
      ArcheryCreatures Marksman = new ArcheryCreatures("Marksman",6,3,10,2,3,2,0,0,2,0,0,"","",1);
      OffenseCreatures Griffin = new OffenseCreatures("Griffin",8,8,25,3,6,1,0,0,3,0,0,"","",1);
      OffenseCreatures RoyalGriffin = new OffenseCreatures("RoyalGriffin",9,9,25,3,6,1,0,0,3,0,0,"","",1);
      OffenseCreatures Swordsman = new OffenseCreatures("Swordsman",10,12,35,6,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures Crusader = new OffenseCreatures("Crusader",12,12,35,7,10,2,0,0,4,0,0,"","",1);
      ArcheryCreatures Monc = new ArcheryCreatures("Monc",12,7,30,10,12,1,0,0,5,0,0,"","",1);
      ArcheryCreatures Zealot = new ArcheryCreatures("Zealot",12,10,30,10,12,1,0,0,5,0,0,"","",1);
      OffenseCreatures Cavalier = new OffenseCreatures("Cavalier",15,15,100,15,25,1,0,0,6,0,0,"","",1);
      OffenseCreatures Champion = new OffenseCreatures("Champion",16,16,100,20,25,1,0,0,6,0,0,"","",1);
      OffenseCreatures Angel = new OffenseCreatures("Angel",20,20,200,50,50, 1,0,0,7,0,0,"Devil","ArchDevil",1.5f);
      OffenseCreatures Archangel = new OffenseCreatures("Archangel",30,30,250,50,50,1,0,0,7,0,0,"Devil","ArchDevil",1.5f);
      ...
      OffenseCreatures Centaur = new OffenseCreatures("Centaur",5,3,8,2,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures CentaurCaptain = new OffenseCreatures("CentaurCaptain",6,3,10,2,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures Dwarf = new OffenseCreatures("Dwarf",6,7,20,2,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures BattleDwarf = new OffenseCreatures("BattleDworf",7,7,20,2,4,1,0,0,2,0,0,"","",1);
      ArcheryCreatures WoodElf = new ArcheryCreatures("WoodElf",9,5,15,3,5,1,0,0,3,0,0,"","",1);
      ArcheryCreatures GrandElf = new ArcheryCreatures("GrandElf",9,5,15,3,5,2,0,0,3,0,0,"","",1);
      OffenseCreatures Pegasus = new OffenseCreatures("Pegasus",9,8,30,5,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures SilverPegasus = new OffenseCreatures("SilverPegasus",9,10,30,5,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures DendroidGuard = new OffenseCreatures("DendroidGuard",9,12,55,10,14,1,0,0,5,0,0,"","",1);
      OffenseCreatures DendroidSoldier = new OffenseCreatures("DendroidSoldier",9,12,65,10,14,1,0,0,5,0,0,"","",1);
      OffenseCreatures Unicorn = new OffenseCreatures("Unicorn",15,14,90,18,22,1,0,0,6,0,0,"","",1);
      OffenseCreatures WarUnicorn = new OffenseCreatures("WarUnicorn",15,14,110,18,22,1,0,0,6,0,0,"","",1);
      OffenseCreatures GreenDragon = new OffenseCreatures("GreenDragon",18,18,180,40,50,1,0,0,7,0,0,"","",1);
      OffenseCreatures GoldDragon = new OffenseCreatures("GoldDragon",27,27,250,40,50,1,0,0,7,0,0,"","",1);
      ...
      OffenseCreatures Gremlin = new OffenseCreatures("Gremlin",3,3,4,1,2,1,0,0,1,0,0,"","",1);
      ArcheryCreatures MasterGremlin = new ArcheryCreatures("MasterGremlin",4,4,4,1,2,1,0,0,1,0,0,"","",1);
      OffenseCreatures StoneGargoyle = new OffenseCreatures("StoneGargoyle",6,6,16,2,3,1,0,0,2,0,0,"","",1);
      OffenseCreatures ObsidianGargoyle = new OffenseCreatures("ObsidianGargoyle",7,7,16,2,3,1,0,0,2,0,0,"","",1);
      OffenseCreatures StoneGolem = new OffenseCreatures("StoneGolem",7,10,30,4,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures IronGolem = new OffenseCreatures("IronGolem",9,10,35,4,5,1,0,0,3,0,0,"","",1);
      ArcheryCreatures Mage = new ArcheryCreatures("Mage",11,8,25,7,9,1,0,0,4,0,0,"","",1);
      ArcheryCreatures ArchMage = new ArcheryCreatures("ArchMage",12,9,30,7,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures Genie = new OffenseCreatures("Genie",12,12,40,13,16,1,0,0,5,0,0,"Efreet","EfreetSultan",1.5f);
      OffenseCreatures MasterGenie = new OffenseCreatures("MasterGenie",12,12,40,13,16,1,0,0,5,0,0,"Efreet","EfreetSultan",1.5f);
      OffenseCreatures Naga = new OffenseCreatures("Naga",16,13,110,20,20,1,0,0,6,0,0,"","",1);
      OffenseCreatures NagaQueen = new OffenseCreatures("NagaQueen",16,13,110,30,30,1,0,0,6,0,0,"","",1);
      OffenseCreatures Giant = new OffenseCreatures("Giant",19,16,150,40,60,1,0,0,7,0,0,"","",1);
      ArcheryCreatures Titan = new ArcheryCreatures("Titan",24,24,300,40,60,1,0,0,7,0,0,"BlackDragon","",1.5f);
      ...
      OffenseCreatures Imp = new OffenseCreatures("Imp",2,3,4,1,2,1,0,0,1,0,0,"","",1);
      OffenseCreatures Familiar = new OffenseCreatures("Familiar",4,4,4,1,2,1,0,0,1,0,0,"","",1);
      ArcheryCreatures Gog = new ArcheryCreatures("Gog",6,4,13,2,4,1,0,0,2,0,0,"","",1);
      ArcheryCreatures Magog = new ArcheryCreatures("Magog",7,4,13,2,4,1,0,0,2,0,0,"","",1);
      OffenseCreatures HellHound = new OffenseCreatures("HellHound",10,6,25,2,7,1,0,0,3,0,0,"","",1);
      OffenseCreatures Cerberus = new OffenseCreatures("Cerberus",10,8,25,2,7,1,0,0,3,0,0,"","",1);
      OffenseCreatures Demon = new OffenseCreatures("Demon",10,10,35,7,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures HornedDemon = new OffenseCreatures("HornedDemon",10,10,40,7,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures PitFiend = new OffenseCreatures("PitFiend",13,13,45,13,17,1,0,0,5,0,0,"","",1);
      OffenseCreatures PitLord = new OffenseCreatures("PitLord",13,13,45,13,17,1,0,0,5,0,0,"","",1);
      OffenseCreatures Efreet = new OffenseCreatures("Efreet",16,12,90,16,24,1,0,0,6,0,0,"Genie","MasterGenie",1.5f);
      OffenseCreatures EfreetSultan = new OffenseCreatures("EfreetSultan",16,14,90,16,24,1,0,0,6,0,0,"Genie","MasterGenie",1.5f);
      OffenseCreatures Devil = new OffenseCreatures("Devil",19,21,160,30,40,1,0,0,7,0,0,"Angel","Archangel",1.5f);
      OffenseCreatures ArchDevil = new OffenseCreatures("ArchDevil",26,28,200,30,40,1,0,0,7,0,0,"Angel","Archangel",1.5f);
      ...
      OffenseCreatures Skeleton = new OffenseCreatures("Skeleton",5,4,6,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures SkeletonWarrior = new OffenseCreatures("SkeletonWarrior",6,6,6,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures WalkingDead = new OffenseCreatures("WalkingDead",5,5,15,2,3,1,0,0,2,0,0,"","",1);
      OffenseCreatures Zombie = new OffenseCreatures("Zombie",5,5,20,2,3,1,0,0,2,0,0,"","",1);
      OffenseCreatures Wight = new OffenseCreatures("Wight",7,7,18,3,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures Wraith = new OffenseCreatures("Wraith",7,7,18,3,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures Vampire = new OffenseCreatures("Vampire",10,9,30,5,8,1,0,0,4,0,0,"","",1);
      OffenseCreatures VampireLord = new OffenseCreatures("VampireLord",10,10,40,5,8,1,0,0,4,0,0,"","",1);
      ArcheryCreatures Lich = new ArcheryCreatures("Lich",13,10,30,11,13,1,0,0,5,0,0,"","",1);
      ArcheryCreatures PowerLich = new ArcheryCreatures("PowerLich",13,10,40,11,15,1,0,0,5,0,0,"","",1);
      OffenseCreatures BlackNight = new OffenseCreatures("BlackNight",16,16,120,15,30,1,0,0,6,0,0,"","",1);
      DreadNights DreadNight = new DreadNights("DreadNight",18,18,120,15,30,1,0,0,6,0,0,"","",1);
      OffenseCreatures BoneDragon = new OffenseCreatures("BoneDragon",17,15,150,25,50,1,0,0,7,0,0,"","",1);
      OffenseCreatures GhostDragon = new OffenseCreatures("GhostDragon",19,17,200,25,50,1,0,0,7,0,0,"","",1);
      ...
      OffenseCreatures Troglodyte = new OffenseCreatures("Troglodyte",4,3,5,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures InfernalTroglodyte = new OffenseCreatures("InfernalTroglodyte",5,4,6,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures Harpy = new OffenseCreatures("Harpy",6,5,14,1,4,1,0,0,2,0,0,"","",1);
      OffenseCreatures HarpyHag = new OffenseCreatures("HarpyHag",6,6,14,1,4,1,0,0,2,0,0,"","",1);
      ArcheryCreatures Beholder = new ArcheryCreatures("Beholder",9,7,22,3,5,1,0,0,3,0,0,"","",1);
      ArcheryCreatures EvilEye = new ArcheryCreatures("EvilEye",10,8,22,3,5,1,0,0,3,0,0,"","",1);
      ArcheryCreatures Medusa = new ArcheryCreatures("Medusa",9,9,25,6,8,1,0,0,4,0,0,"","",1);
      ArcheryCreatures MedusaQueen = new ArcheryCreatures("MedusaQueen",10,10,30,6,8,1,0,0,4,0,0,"","",1);
      OffenseCreatures Minotaur = new OffenseCreatures("Minotaur",14,12,50,12,20,1,0,0,5,0,0,"","",1);
      OffenseCreatures MinotaurKing = new OffenseCreatures("MinotaurKing",15,15,50,12,2,1,0,0,5,0,0,"","",1);
      OffenseCreatures Manticore = new OffenseCreatures("Manticore",15,13,80,14,20,1,0,0,6,0,0,"","",1);
      OffenseCreatures Scorpicore = new OffenseCreatures("Scorpicore",16,14,80,14,20,1,0,0,6,0,0,"","",1);
      OffenseCreatures RedDragon = new OffenseCreatures("RedDragon",19,19,180,40,50,1,0,0,7,0,0,"","",1);
      OffenseCreatures BlackDragon = new OffenseCreatures("BlackDragon",25,25,300,40,50,1,0,0,7,0,0,"Titan","",1.5f);
      ...
      OffenseCreatures Goblin = new OffenseCreatures("Goblin",4,2,5,1,2,1,0,0,1,0,0,"","",1);
      OffenseCreatures Hobgoblin = new OffenseCreatures("Hobgoblin",5,3,5,1,2,1,0,0,1,0,0,"","",1);
      OffenseCreatures WolfRider = new OffenseCreatures("WolfRider",7,5,10,2,4,1,0,0,2,0,0,"","",1);
      OffenseCreatures WolfRaider = new OffenseCreatures("WolfRaider",8,5,10,3,4,2,0,0,2,0,0,"","",1);
      ArcheryCreatures Orc = new ArcheryCreatures("Orc",8,4,15,2,5,1,0,0,3,0,0,"","",1);
      ArcheryCreatures OrcChieftain = new ArcheryCreatures("OrcChieftain",8,4,20,2,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures Ogre = new OffenseCreatures("Ogre",13,7,40,6,12,1,0,0,4,0,0,"","",1);
      OffenseCreatures OgreMage = new OffenseCreatures("OgreMage",13,7,60,6,12,1,0,0,4,0,0,"","",1);
      OffenseCreatures Roc = new OffenseCreatures("Roc",13,11,60,11,15,1,0,0,5,0,0,"","",1);
      OffenseCreatures Thunderbird = new OffenseCreatures("Thunderbird",13,11,60,11,15,1,0,0,5,0,0,"","",1);
      ArcheryCreatures Cyclop = new ArcheryCreatures("Cyclop",15,12,70,16,20,1,0,0,6,0,10,"","",1);
      ArcheryCreatures CyclopsKing = new ArcheryCreatures("CyclopsKing",17,13,70,16,20,1,0,0,6,0,0,"","",1);
      OffenseCreatures Behemoth = new OffenseCreatures("Behemoth",17,17,175, 30, 50, 1,0.3f,0,7,0,0,"","",1);
      OffenseCreatures AncientBehemoth = new OffenseCreatures("AncientBehemoth",19,19,300,30,50,1,0.8f,0,7,0,0,"","",1);
      ...
      OffenseCreatures Gnoll = new OffenseCreatures("Gnoll",3,5,6,2,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures GnollMarauder = new OffenseCreatures("GnollMarauder",4,6,6,2,3,1,0,0,1,0,0,"","",1);
      ArcheryCreatures Lizardman = new ArcheryCreatures("Lizardman",5,6,14,2,3,1,0,0,2,0,0,"","",1);
      ArcheryCreatures LizardWarrior = new ArcheryCreatures("LizardWarrior",6,8,15,2,5,1,0,0,2,0,0,"","",1);
      OffenseCreatures SerpentFly = new OffenseCreatures("SerpentFly",7,9,20,2,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures DragonFly = new OffenseCreatures("DragonFly",8,10,20,2,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures Basilisk = new OffenseCreatures("Basilisk",11,11,35,6,10,1,0,0,4,0,0,"","",1);
      OffenseCreatures GreaterBasilisk = new OffenseCreatures("GreaterBasilisk",12,12,40,6,10,1,0,0,4,0,0,"","",1);
      OffenseCreatures Gorgon = new OffenseCreatures("Gorgon",10,14,70,12,16,1,0,0,5,0,0,"","",1);
      OffenseCreatures MightyGorgon = new OffenseCreatures("MightyGorgon",11,16,70,12,16,1,0,0,5,0.1f,0,"","",1);
      OffenseCreatures Wyvern = new OffenseCreatures("Wyvern",14,14,70,14,18, 1, 0,0,6,0,0,"","",1);
      OffenseCreatures WyvernMonarch = new OffenseCreatures("WyvernMonarch",14,14,70,18,22,1,0,0,6,0,0,"","",1);
      OffenseCreatures Hydra = new OffenseCreatures("Hydra",16,18,160,25,45,1,0,0,7,0,0,"","",1);
      OffenseCreatures ChaosHydra = new OffenseCreatures("ChaosHydra",18,20,250,25,45,1,0,0,7,0,0,"","",1);
      ...
      OffenseCreatures Pixie = new OffenseCreatures("Pixie",2,2,3,1,2,1,0,0,1,0,0,"","",1);
      OffenseCreatures Sprite = new OffenseCreatures("Sprite",2,2,3,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures AirElemental = new OffenseCreatures("AirElemental",9,9,25,2,8,1,0,0,2,0,0,"EarthElemental","",2);
      ArcheryCreatures StormElemental = new ArcheryCreatures("StormElemental",9,9,25,2,8,1,0,0,2,0,0,"EarthElemental","",2);
      OffenseCreatures WaterElemental = new OffenseCreatures("WaterElemental",8,10,30,3,7,1,0,0,3,0,0,"FireElemental","",2);
      ArcheryCreatures IceElemental = new ArcheryCreatures("IceElemental",8,10,30,3,7,1,0,0,3,0,0,"FireElemental","",2);
      OffenseCreatures FireElemental = new OffenseCreatures("FireElemental",10,8,35,4,6,1,0,0,4,0,0,"WaterElemental","",2);
      OffenseCreatures EnergyElemental = new OffenseCreatures("EnergyElemental",12,8,35,4,6,1,0,0,4,0,0,"WaterElemental","",2);
      OffenseCreatures EarthElemental = new OffenseCreatures("EarthElemental",10,10,40,4,8,1,0,0,5,0,0,"AirElemental","",2);
      OffenseCreatures MagmaElemental = new OffenseCreatures("MagmaElemental",11,11,40,6,11,1,0,0,5,0,0,"AirElemental","",2);
      OffenseCreatures PsychicElemental = new OffenseCreatures("PsychicElemental",15,13,75,10,20,1,0,0,6,0,0,"","",1);
      OffenseCreatures MagicElemental = new OffenseCreatures("MagicElemental",16,13,80,15,25,1,0,0,6,0,0,"","",1);
      OffenseCreatures Firebird = new OffenseCreatures("Firebird",18,18,150,30,40,1,0,0,7,0,0,"","",1);
      OffenseCreatures Phoenix = new OffenseCreatures("Phoenix",21,18,200,30,40,1,0,0,7,0,0,"","",1);
      ...
      OffenseCreatures Nymph = new OffenseCreatures("Nymph",5,2,4,1,2,1,0,0,1,0,0,"","",1);
      OffenseCreatures Oceanid = new OffenseCreatures("Oceanid",6,2,4,1,3,1,0,0,1,0,0,"","",1);
      OffenseCreatures Sailor = new OffenseCreatures("Sailor",7,4,15,2,4,1,0,0,2,0,0,"","",1);
      OffenseCreatures Thug = new OffenseCreatures("Thug",8,6,15,3,4,1,0,0,2,0,0,"","",1);
      ArcheryCreatures Pirate = new ArcheryCreatures("Pirate",8,6,15,3,7,1,0,0,3,0,0,"","",1);
      ArcheryCreatures Corsair = new ArcheryCreatures("Corsair",10,8,15,3,7,1,0,0,3,0,0,"","",1);
      ArcheryCreatures SeaWolfs = new ArcheryCreatures("SeaWolfs",12,11,16,3,7,1,0,0,3,0.03f,0,"","",1);
      OffenseCreatures OceanSpirits = new OffenseCreatures("OceanSpirits",10,8,30,6,9,1,0,0,4,0,0,"","",1);
      Assids Assid = new Assids("Assid",11,8,30,6,10,1,0,0,4,0,0,"","",1);
      ArcheryCreatures SeaPriestess = new ArcheryCreatures("SeaPriestess",12,7,35,10,14,1,0,0,5,0,0,"","",1);
      ArcheryCreatures Charmer = new ArcheryCreatures("Charmer",12,9,35,10,16,1,0,0,5,0,0,"","",1);
      OffenseCreatures Nix = new OffenseCreatures("Nix",13,16,90,18,20,1,0,0.3f,6,0,0,"","",1);
      OffenseCreatures WarriorNix = new OffenseCreatures("WarriorNix",14,17,100,18,22,1,0,0.6f,6,0,0,"","",1);
      OffenseCreatures SeaSnake = new OffenseCreatures("SeaSnake",22,13,180,30,55,1,0,0,7,0,0,"","",1);
      OffenseCreatures Aspid = new OffenseCreatures("Aspid",29,20,300,30,55,1,0,0,7,0,0,"","",1);
      ...
      ArcheryCreatures Hobbit = new ArcheryCreatures("Hobbit",4,2,3,1,3,1,0,0,1,0,0,"","",1);
      ArcheryCreatures GrenadierHobbit = new ArcheryCreatures("GrenadierHobbit",5,2,3,2,3,1,0.2f,0,1,0,0,"","",1);
      OffenseCreatures Mechanic = new OffenseCreatures("Mechanic",6,5,14,2,4,1,0,0,2,0,0,"","",1);
      OffenseCreatures Engineer = new OffenseCreatures("Engineer",7,5,16,2,5,1,0,0,2,0,0,"","",1);
      OffenseCreatures Armadillo = new OffenseCreatures("Armadillo",5,10,25,3,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures ChiefArmadillo = new OffenseCreatures("ChiefArmadillo",5,11,25,3,5,1,0,0,3,0,0,"","",1);
      OffenseCreatures Automaton = new OffenseCreatures("Automaton",12,10,30,7,7,1,0,0,4,0,0,"","",1);
      OffenseCreatures AutomatonGuard = new OffenseCreatures("AutomatonGuard",12,10,30,9,9,1,0,0,4,0,0,"","",1);
      OffenseCreatures SoundWorm = new OffenseCreatures("SoundWorm",13,12,50,12,16,1,0,0,5,0,0,"","",1);
      OffenseCreatures OlgoyHorkoy = new OffenseCreatures("OlgoyHorkoy",15,12,60,12,16,1,0,0,5,0,0,"","",1);
      ArcheryCreatures Gunner = new ArcheryCreatures("Gunner",17,12,45,14,24,1,0,0,6,0,0,"","",1);
      ArcheryCreatures BountyHunter = new ArcheryCreatures("BountyHunter",18,14,45,14,24,1,0,0,6,0,0,"","",1);
      OffenseCreatures Couatl = new OffenseCreatures("Couatl",17,17,160,25,45,1,0,0,7,0,0,"","",1);
      OffenseCreatures CrimsonCouatl = new OffenseCreatures("CrimsonCouatl",21,21,200,25,45,1,0,0,7,0,0,"","",1);
      OffenseCreatures Dreadnought = new OffenseCreatures("Dreadnought",18,20,200,40,50,1,0,0,7,0,0,"","",1);
      OffenseCreatures Juggernaut = new OffenseCreatures("Juggernaut",23,23,300,40,50,1,0,0,7,0,0,"","",1);
      ...
      OffenseCreatures Peasant = new OffenseCreatures("Peasant",1,1,1,1,1,1,0,0,1,0,0,"","",1);
      OffenseCreatures Rogue = new OffenseCreatures("Rogue",8,3,10,2,4,1,0,0,2,0,0,"","",1);
      OffenseCreatures Boar = new OffenseCreatures("Boar",6,5,15,2,3,1,0,0,2,0,0,"","",1);
      OffenseCreatures Nomad = new OffenseCreatures("Nomad",9,8,30,2,6,1,0,0,3,0,0,"","",1);
      OffenseCreatures Mummy = new OffenseCreatures("Mummy",7,7,30,3,5,1,0,0,3,0,0,"","",1);
      ArcheryCreatures Sharpshooter = new ArcheryCreatures("Sharpshooter",12,10,15,8,10,1,0,0,4,0,0,"","",1);
      OffenseCreatures GoldGolem = new OffenseCreatures("GoldGolem",11,12,50,8,10,1,0,0,5,0,0,"","",1);
      OffenseCreatures Troll = new OffenseCreatures("Troll",14,7,40,10,15,1,0,0,5,0,0,"","",1);
      OffenseCreatures DiamondGolem = new OffenseCreatures("DiamondGolem",13,12,60,10,14,1,0,0,6,0,0,"","",1);
      OffenseCreatures Enchanter = new OffenseCreatures("Enchanter",17,12,30,14,14,1,0,0,6,0,0,"","",1);
      OffenseCreatures FaerieDragon = new OffenseCreatures("FaerieDragon",20,20,500,20,30,1,0,0,7,0,0,"","",1);
      OffenseCreatures RustDragon = new OffenseCreatures("RustDragon",30,30,750,50,50,1,0,0,7,0,0,"","",1);
      OffenseCreatures CrystalDragon = new OffenseCreatures("CrystalDragon",40,40,800,60,75,1,0,0,7,0,0,"","",1);
      OffenseCreatures AzureDragon = new OffenseCreatures("AzureDragon",50,50,1000,70,80,1,0,0,7,0,0,"","",1);

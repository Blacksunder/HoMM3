...
public class Controller {
    ...
    // Добавление существ Замка (Castle)
      ...
      ObservableList<String> Rampart = FXCollections.observableArrayList(Centaur.Name,CentaurCaptain.Name, Dwarf.Name, BattleDwarf.Name, WoodElf.Name, GrandElf.Name, Pegasus.Name, SilverPegasus.Name, DendroidGuard.Name, DendroidSoldier.Name, Unicorn.Name,WarUnicorn.Name, GreenDragon.Name, GoldDragon.Name);
